...
#### Sample screenshot of translate\_sentence POST request

Go to [API documentation](http://216.48.181.177:5050/docs#), scroll to translate\_sentence POST request endpoint and click "Try it out" button.
