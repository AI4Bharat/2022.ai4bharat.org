        ...
        <div className="flex items-center justify-between flex-wrap">
          <div className="w-0 flex-1 flex items-center">
            ...
            <p className="ml-3 font-medium text-white truncate">
              <span className="md:hidden">AI4Bhārat Launch at IIT Madras on 28th July 2022</span>
              <span className="hidden md:inline">AI4Bhārat Launch at IIT Madras on 28th July 2022 !</span>
            </p>
          </div>
