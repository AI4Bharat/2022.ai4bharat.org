...
export const LongCard = ({ featuresColor, data, tinaField }) => {
  // console.log(data)
  // console.log(data.link)
  // console.log(typeof(data.comingSoon))
  return (

  <div className="relative transform rounded overflow-hidden shadow-xl mb-6 max-w-4xl mx-auto hover:bg-gray-50 transition duration-500 hover:scale-110" data-tinafield={tinaField}>
...
export const LongCardsGrid = ({ data, parentField }) => {
  return (
...
export const longCardsGridBlockSchema: TinaTemplate = {
  name: "longCardsGrid",
  label: "LongCardsGrid",
  ui: {
    previewSrc: "/blocks/features.png",
    defaultItem: {
      items: [defaultLongCard, defaultLongCard, defaultLongCard],
    },
  },
  fields: [
    {
